...
title: >-
  ...
  Molecular Interactions - with scFoundation, AIDO.Cell, and scPRINT
permalink: /decoding_sc_foundation_models_part2/with-scfoundation/
sitemap: false
...
This version excludes scGPT, allowing comparison at transcriptome-wide
scale over a shared vocabulary of 5096--9975 genes constrained by
scFoundation's expression-dependent vocabulary.
...
![](/figure/source/2026-05-25-decoding_sc_foundation_models_part2_with-scfoundation/visualize_xmodel_layer_attention_consistency-output-1.png)
...
![](/figure/source/2026-05-25-decoding_sc_foundation_models_part2_with-scfoundation/edge_prediction_scores_by_edge_existence-output-1.png)
...
![](/figure/source/2026-05-25-decoding_sc_foundation_models_part2_with-scfoundation/edge_prediction_scores_and_existence_by_model-output-1.png)

![](/figure/source/2026-05-25-decoding_sc_foundation_models_part2_with-scfoundation/edge_prediction_scores_and_existence_by_model-output-2.png)
...
-   **scPRINT (large) shows a dissociation between edge rate and GNN
    ...
    <p>scFoundation's near-null interaction recovery likely reflects a fundamental architectural constraint rather than a failure of the model itself. Its asymmetric encoder-decoder design processes only expressed genes through the encoder, recombining those representations with zero-expressed gene embeddings only at the decoder stage to produce final gene-level representations. The residual streams extracted here come from the encoder alone, which has never attended over the full transcriptome. The regulatory signal in scFoundation is probably concentrated in the decoder outputs, but the decoder is closed source, making this analysis of the encoder the limit of what is publicly accessible. This is worth keeping in mind when comparing scFoundation to the other models here, all of which expose their full forward pass.</p>
...
![](/figure/source/2026-05-25-decoding_sc_foundation_models_part2_with-scfoundation/edge_cosine_similarity_relative_to_universe-output-1.png)
...
![](/figure/source/2026-05-25-decoding_sc_foundation_models_part2_with-scfoundation/cross_model_coherence_vs_mechanistic_strength-output-1.png)
