...
From scraping the Sherdog database, I obtained data from `r nrow(fighters)` encompassing `r nrow(bouts)` fight entries. While I will leave deeper analysis of this dataset for the future, one aspect of this dataset that we can quickly look at is how many fights MMA fighters usually have.

```{r nfights, dependson="load data", fig.width=6}
...
```{r fight dates, dependson="load data", fig.width=6, warning=F}
