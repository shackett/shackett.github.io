...
Looking at this histogram of # of bouts in a fighter's career, it is clear that the majority of fighters have very short careers. Only `r fight_counts %>% filter(n > 10) %>% nrow` fighters have fought in more than 10 MMA bouts. 
