...
This analysis works with the same environment and extracted model summaries (weights, residual streams) from the [Part 1 notebook](https://www.shackett.org/decoding_sc_foundation_models_part1), see the [Reproducing this analysis](https://www.shackett.org/decoding_sc_foundation_models_part1#reproducing-this-analysis) section for details.
...
CHECK, CROSS = "✅", "❌"
VARIANT_TABLE_FIELDS = ["link", "scGPT", "scFoundation", "AIDO_Cell", "scPRINT", "# genes"]
VARIANT_FIELD_TITLES = {"AIDO_Cell": "AIDO.Cell", "link": ""}
...
if INCLUDE_SCFOUNDATION:
    ...
    scfoundation_aside = (
        ...
        "[with scFoundation included](/decoding_sc_foundation_models_part2/with-scfoundation/)) "
        + scfoundation_aside_body
    )

print(f'{{% include ai-aside.html content="\n{scfoundation_aside}\n" %}}')
```
